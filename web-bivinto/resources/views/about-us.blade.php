    ...
    <section class="about-hero">
        <div class="container-fluid px-0">
            ...
            <div class="about-hero-image-wrapper">
                ...
                @endphp
                <img src="{{ $heroSrc }}" alt="Hành trình xây dựng phong thái đàn ông Việt"
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row g-0 about-story-header">
                <div class="col-md-6 d-flex flex-column justify-content-center story-header-left">
                    ...
                    <p class="about-subtitle m-0">{{ get_setting('aboutpage_story_subtitle', '"Nơi Mọi Hành Trình Mạnh Mẽ Bắt Đầu"') }}</p>
                </div>
                <div class="col-md-6 d-flex align-items-center story-header-right">
                    <div class="row g-2 g-md-4 w-100 m-0">
                        <div class="col-sm-6 ps-0">
                            <p class="story-small-text m-0">{{ get_setting('aboutpage_story_intro_left', 'Bivinto không bắt đầu từ những trung tâm thời trang sôi động hay những cơ hội sẵn có.') }}</p>
                        </div>
                        <div class="col-sm-6 pe-0">
                            <p class="story-small-text m-0">{{ get_setting('aboutpage_story_intro_right', 'Thương hiệu được hình thành từ một khát vọng rất giản đơn: "Giúp đàn ông Việt dễ dàng tiếp cận thời trang phù hợp với phong thái và sự tự tin hơn trên hành trình chinh phục mục tiêu".') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0 flex-column-reverse flex-md-row">
                <div class="col-md-6 d-flex flex-column justify-content-center story-text-box">
                    {!! get_setting('aboutpage_story_content2', '<p class="about-desc mb-3 mb-md-4">Hành trình xây dựng Bivinto không bắt đầu bằng những điều thuận lợi.</p><p class="about-desc mb-3 mb-md-4">Từ việc nghiên cứu sản phẩm, tìm kiếm đối tác sản xuất, kiểm soát chất lượng, xây dựng đội ngũ cho đến phát triển thương hiệu, mọi bước đi đều là những thử thách mới. Nhưng cũng giống như hành trình trưởng thành của mỗi người đàn ông, chính những khó khăn ấy đã tạo nên bản lĩnh và sự kiên định.</p><p class="about-desc m-0">Bivinto tin rằng: <strong>"Điều tạo nên sự khác biệt không phải những gì ta đang có, mà là những gì ta dám theo đuổi"</strong>. Đó cũng là tinh thần mà thương hiệu muốn truyền tải đến khách hàng thông qua từng sản phẩm và trải nghiệm.</p>') !!}
                </div>
                <div class="col-md-6 d-flex align-items-start">
                    <img src="{{ $storySrc2 }}" class="w-100 object-fit-cover story-grid-img"
        ...
        <div class="container px-0 py-md-4">
            <div class="row m-0">
                <div class="col-lg-6 ps-0">
                    <h2 class="about-title mb-5 mb-lg-0 text-start">{{ get_setting('aboutpage_belief_title', 'CHÚNG TÔI TIN RẰNG') }}</h2>
                </div>
                <div class="col-lg-6 ps-lg-5 pe-0">
                    <div class="belief-item">
                        ...
                        <p class="meaning-text mt-3 mb-0">{{ get_setting('aboutpage_belief1_desc', 'Đó là cách một người đàn ông thể hiện sự tôn trọng với chính mình và những người xung quanh.') }}</p>
                    </div>
                    ...
                    <div class="belief-item">
                        ...
                        <p class="meaning-text mt-3 mb-0">{{ get_setting('aboutpage_belief2_desc', 'Một bộ trang phục đúng gu, vừa vặn và chỉn chu có thể thay đổi cách một người xuất hiện mỗi ngày.') }}</p>
                    </div>
                    <hr class="belief-divider">
                    <div class="belief-item">
                        <h4 class="meaning-subtitle">{!! get_setting('aboutpage_belief3_title', 'ĐƠN GIẢN<br>NHƯNG KHÁC BIỆT') !!}</h4>
                        <p class="meaning-text mt-3 mb-0">{{ get_setting('aboutpage_belief3_desc', 'Bivinto không chạy theo xu hướng nhất thời. Chúng tôi tập trung vào những giá trị bền vững, tính ứng dụng cao và sự tinh tế trong từng chi tiết.') }}</p>
                    </div>
                </div>
            </div>
        </div>
